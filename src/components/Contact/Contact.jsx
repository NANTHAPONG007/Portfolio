    ...
    <div className={styles.contact_wrapper}>
        <div className={styles.contact_con}>
            <div className={styles.contact_info}>
                ...
                <p><MdAlternateEmail/>bass007yub@gmail.com</p>
                <p><SiWhatsapp/>Bass007yub</p>
            </div>
                ...
                <form action="">
                    <div className={styles.input_group}>
                        <div>
                            ...
                            <input type="text" placeholder="eg. Nanthapong"></input>
                        </div>
                        <div>
                            <label htmlFor="last name">Last Name</label>
                            <input type="text" placeholder="eg. Wongrat"></input>
                        </div>
                    </div>
                    <label htmlFor="email address">Email Address</label>
                    <input type="email" placeholder="eg. bass007yub@gmail.com" />
